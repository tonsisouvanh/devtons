    ...
    <>
      <div className="relative">
        ...
        <div className="relative">
          ...
          {/* Main section */}
          <div className="relative">
            <div className="w-full h-full absolute top-0 left-0 -z-20 hidden lg:flex ">
              <img
                src={svgBackground}
            ...
            <section
              id="about"
              className="relative rounded-div flex flex-col p-16 justify-center items-start space-y-6 md:flex-row md:justify-between"
            >
              {/* Image */}
          ...
          <section className="rounded-lg rounded-div p-2 my-10 sm:my-20 animate-[fadeBottom_1s_linear] md:my-561">
            <div className="flex items-center">
              {/* <!-- The left line --> */}
              {/* <div className="flex-grow h-[3px] bg-accent"></div> */}

              {/* <h2 className="text-primary text-2xl font-bold text-center w-full mx-3 sm:text-4xl"> */}
              <h2 className="text-primary text-2xl font-bold text-center w-full mx-3 sm:text-4xl">
                About Me
              </h2>
          ...
          <motion.section
            ...
            viewport={{ once: true, amount: 0.2 }}
            transition={{ staggerChildren: 0.2 }}
            className="rounded-div mb-16 md:mb-60 animate-fade-in-from-right"
          >
            <motion.div variants={HeaderAnimate} className="flex items-center">
              <h2 className="text-primary text-2xl font-bold text-center sm:text-4xl mr-3">
                Tech Tools
          ...
          <motion.section
            ...
            className="rounded-div mb-32 md:mb-66 animate-fade-in-from-right"
          >
            <motion.div variants={HeaderAnimate} className="flex items-center">
              <h2 className="text-primary text-2xl font-bold text-center sm:text-4xl mr-3">
                Contact
